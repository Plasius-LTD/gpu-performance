...
**Project:** @plasius/gpu-performance (Plasius LTD)  
...
- **"Project"** means the @plasius/gpu-performance repositories and related materials owned or managed by **Plasius LTD**.
